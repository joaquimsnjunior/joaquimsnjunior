<table>
  <tr>
    <td  width="400">
      <img src="image-pixel.jpg" width="400" alt="Socrates And Aristotle">
    </td>
    <td valign="top">
      <h1>Joaquim Silva</h1>
      <p>Engineer focused on reliability, performance, and distributed systems. Building infrastructure that never sleeps.</p>
      <h2>Technologies</h2>
      <ul>
